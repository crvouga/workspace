...
export const viewWorkCardMediaImage: ViewWithProps<WorkCardMediaProps> = (
  props
) => {
...
const viewWorkCardMediaImageMain: ViewWithProps<WorkCardMediaProps> =
  (props) => (attr, _) => {
...
const viewWorkCardMediaGradient: ViewWithProps<{ work: Work }> =
  (_) => (attr, _c) => {
