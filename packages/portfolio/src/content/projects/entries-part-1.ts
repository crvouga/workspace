...
export const PROJECT_ENTRIES_PART_1: readonly Project[] = [
  ...
  },
  {
    ...
    title: 'Mockingbird',
    setting: 'side',
    deployment: { t: 'public', url: 'https://mockingbird.chrisvouga.dev/' },
    code: { t: 'public', url: 'https://github.com/crvouga/mockingbird' },
    description:
      "Stateful test doubles for 42 third-party APIs and SQL databases. Each mock reproduces the vendor's real surface and state in-process, with shared controls for isolation, time, faults, snapshots and request journals across Node, Bun, browsers and Workers.",
    imageAlt: IMAGE_ALT,
    imageSrc: ['/mockingbird-screenshot.optimized.webp'],
    galleryImageSrc: ['/mockingbird-screenshot.optimized.webp'],
    topics: ['typescript', 'bun', 'nodejs', 'sqlite'],
  },
  {
    id: 'orchard',
    title: 'Orchard',
