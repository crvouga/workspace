...
export const linkedIn: View = (a, _) => {
  return icon(
    a,
    `<svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.79M6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z"></path></svg>`
  );
};

export const github: View = (a, _) => {
  return icon(
    a,
...
export const download: View = (a, _) => {
  return icon(
    a,
    `<svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" fill="currentColor"><path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"></path></svg>`
  );
};

export const mail: View = (a, _) => {
  return icon(
    a,
    `<svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" fill="currentColor"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"></path></svg>`
  );
};

export const infoOutline: View = (attrs, _) => {
  return icon(
    attrs,
...
export const web: View = (attrs, _children) => {
  return icon(
    attrs,
...
export const _code: View = (attrs, _children) => {
  return icon(
    attrs,
...
export const __code: View = (attrs, _children) => {
  return icon(
    attrs,
...
export const code: View = (attrs, _children) => {
  return icon(
    attrs,
...
export const launch: View = (attrs, _children) => {
  return icon(
    attrs,
...
export const images: View = (attrs, _children) => {
  return icon(
    attrs,
